...
1. **Conversational Input**: User describes interaction in plain English
2. **AI Processing**: LangGraph agent with 5 specialized tools processes the text
3. **Intelligent Extraction**: Structured data extraction using Groq LLM (gemma2-9b-it)
4. **Form Population**: Results displayed in verification-ready format
5. **Database Storage**: Persistent storage in PostgreSQL with full audit trail
...
### **1. Log Interaction** _(Required)_
...
### **2. Edit Interaction** _(Required)_
...
#### **6. Frontend Setup** _(New Terminal)_
...
- **GitHub Issues**: [Create an issue](https://github.com/sahxil/ai-crm-hcp-module/issues)
- **Documentation**: [Project Wiki](https://github.com/sahxil/ai-crm-hcp-module/wiki)
...
_Built with ❤️ for the life science community. Transforming HCP relationship management through conversational AI._
